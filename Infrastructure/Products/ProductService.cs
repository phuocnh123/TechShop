...
namespace Infrastructure.Products
{
    public interface IProductService
    {
        ...
        // Task<ResponseResult> UpdateProduct(ProductCreateViewModel model);
    }
    public class ProductService : IProductService
    {
        ...
        public async Task<ResponseResult> CreateProduct(ProductCreateViewModel model)
        {
            ...
            Guid productId = model.ProductId ?? Guid.NewGuid();
            try
            {
                ...
                if(model.ProductId == null) _context.Products.Add(product);
        ...
        //public async Task<ResponseResult> UpdateProduct(ProductCreateViewModel model)
        //{
        //    using var transcation = await _context.Database.BeginTransactionAsync();
        //    try
        //    {
        ...
        //        }
        //        await transcation.CommitAsync();
        //        return new ResponseResult(200, "Update product successfully");
        //    }
        //    catch (Exception)
        //    {
        //        await transcation.RollbackAsync();
